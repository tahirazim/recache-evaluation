...
legend = ax.legend(loc='lower right',  framealpha=0.0, fontsize=24, 
                   borderpad=0, bbox_to_anchor=(1.02,0.1))
...
fig.savefig("yelp_varying_nested_attributes.pdf", dpi=200, bbox_inches='tight')
#plt.show()
